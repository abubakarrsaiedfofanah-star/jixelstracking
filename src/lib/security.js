...
const rolePermissions = {
  "Super administrator": ["*"],
  "Operations manager": ["Dashboard", "Customers", "Products", "GPS Trackers", "Live Map", "Screening", "Support Cases", "Alerts", "Reports"],
  "Finance officer": ["Dashboard", "Customers", "Payments", "Finance Accounts", "Reports"],
  "Support agent": ["Dashboard", "Customers", "Products", "GPS Trackers", "Live Map", "Screening", "Support Cases", "Alerts"],
